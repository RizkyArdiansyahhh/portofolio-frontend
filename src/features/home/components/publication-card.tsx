...
export function PublicationCard({
  ...
  return (
    ...
    >
      {/* 📖 Kolom Kiri: Icon Jurnal/Buku + Garis pembatas dashed */}
      ...
      {/* 📄 Kolom Kanan: Judul Publikasi, Penerbit, Tanggal, & Icon Arrow */}
      <div className="flex-1 flex items-center justify-between px-4 sm:px-5 py-4 min-w-0">
        <div className="min-w-0 pr-4">
          <h3 className="text-sm font-medium text-zinc-100 group-hover:text-white line-clamp-2">
            {title}
          </h3>
